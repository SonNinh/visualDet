...
## path
path = edict()
path.data_path = "/home/ubuntu/data/kitti/training" # used in visualDet3D/data/.../dataset
path.test_path = "/home/ubuntu/data/kitti/testing" # used in visualDet3D/data/.../dataset
...
path.project_path = os.path.join(path.project_path, 'Mono3D_kitti')
if not os.path.isdir(path.project_path):
    os.mkdir(path.project_path)
